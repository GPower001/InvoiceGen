            ...
            <div ref={invoiceRef} className="p-8 md:p-12 bg-white text-slate-900">
              ...
              <div className="flex justify-between items-start mb-12">
                <div>
                  ...
                  <p className="text-slate-500 font-mono text-sm">#{displayInvoice.invoiceNumber}</p>
                  <div className="mt-4">
                    {isEditing ? (
                      <Select 
              ...
              <div className="mb-12 p-6 bg-slate-50 rounded-lg border border-slate-100">
                ...
                {isEditing ? (
                  ...
                  <>
                    <div className="text-lg font-semibold text-slate-900">{displayInvoice.clientName}</div>
                    {displayInvoice.clientEmail && <div className="text-slate-500">{displayInvoice.clientEmail}</div>}
                  </>
                )}
              </div>

              {/* Invoice Details */}
              <div className="grid grid-cols-2 gap-6 mb-12 p-6 bg-slate-50 rounded-lg border border-slate-100">
                <div>
                ...
                <div className="flex justify-end">
                  <div className="w-64 space-y-3">
                    <div className="flex justify-between text-sm text-slate-500">
                      <span>Subtotal</span>
                      <span>{currencySymbol}{items.reduce((sum, item) => sum + (Number(item.price) || 0), 0).toLocaleString()}</span>
                    </div>
                    {displayInvoice.discountRate && displayInvoice.discountRate > 0 && (
                      <div className="flex justify-between text-sm text-slate-500">
                        <span>Discount ({displayInvoice.discountRate}%)</span>
                        <span>-{currencySymbol}{(Number(displayInvoice.discountAmount) || 0).toLocaleString()}</span>
                      </div>
                    )}
